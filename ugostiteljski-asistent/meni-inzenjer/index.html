        ...
        <div class="row">
            ...
            <div class="form-group">
                ...
                <select id="kreativnost">
                    <option value="1">🥉 Klasičan – jednostavan i direktan</option>
                    <option value="2" selected>🥈 Kreativan – živopisan i primamljiv</option>
                    <option value="3">🥇 Signature – jedinstven i autorski</option>
                </select>
            </div>
        </div>
